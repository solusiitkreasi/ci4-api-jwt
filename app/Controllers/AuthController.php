...
class AuthController extends BaseController
{
    ...
    public function register()
    {
        ...
        $rules = [
            ...
            'kode_customer'    => 'required|min_length[3]',
        ...
        $db->transStart();
            ...
            if ($userId === false) {
                $db->transRollback();
                return api_error('Failed to register user', ResponseInterface::HTTP_INTERNAL_SERVER_ERROR, $this->userModel->errors());
            }
        ...
        return api_response($user, 'User registered successfully. Default role "Client" assigned.', ResponseInterface::HTTP_CREATED);
