...
class Common {
  ...
  _initTooltips() {
    ...
    var tooltipTriggerListNoDelay = [].slice.call(
      document.querySelectorAll('.no-delay[data-bs-toggle="tooltip"][data-bs-delay="0"]')
    );
  ...
  _initDropdownAsSelect() {
    ...
    document.querySelectorAll(".dropdown-as-select").forEach((element) => {
      ...
      element.querySelector('[data-bs-toggle="dropdown"]' + childSelector).innerHTML =
        element.querySelector(".dropdown-menu a.active").textContent;
    });
  }
    ...
    document.querySelectorAll(".modal").forEach((el) => {
      ...
      el.addEventListener("show.bs.modal", function (event) {
        ...
        if (document.querySelector('html[data-placement="horizontal"] .nav-container .nav-content')) {
          document.querySelector('html[data-placement="horizontal"] .nav-container .nav-content').style.paddingRight =
            rightPadding;
        }
      });
